...
- (WalkThroughContentViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    WalkThroughContentViewController *walkThroughContentViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"WalkThroughContentViewController"];
    walkThroughContentViewController.imageFile = self.pageImages[index];
    walkThroughContentViewController.titleText = self.pageTitles[index];
